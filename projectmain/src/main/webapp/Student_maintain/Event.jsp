...
<body>
	<div class="fancy">
		<h3>考生資料明細</h3>
		<form id="Student_MaintainForm" action="Student_DetailServlet.do" method="post">
			<input type="hidden" name="action" value="add">
			<p>
				考生代號：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				座號：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				預約報名時間：<%=request.getParameter("id")%>
			</p>
			<p>
				考生姓名：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				年次：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>		
				狀況代號：<%=request.getParameter("id")%>
			</p>
			<p>
				班級代號：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				畢業學校：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				主考官代號：<%=request.getParameter("id")%>
			</p>
			<p>
				考生E-mail：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				性別：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				確認時間：<%=request.getParameter("id")%>
			</p>
			<p>
				組別：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				考試時間：<%=request.getParameter("id")%>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				是否已約上機考：<%=request.getParameter("id")%>
			</p>
			<hr>
			<p>
				上機測驗分數：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				總分：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				Final Ranking：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
			</p>
			<p>
				上機測驗時間：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				最快可上班日：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				備註1：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
			</p>
			<p>
				Interview分數：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				期望薪資：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				備註2：<input type="text" class="input datepicker" name="startdate"
					id="startdate" value=<%=request.getParameter("start")%>>
			</p>
