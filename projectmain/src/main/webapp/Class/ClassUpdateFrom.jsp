				...
				<form class="form-search">
					...
					<div class=row>
						...
						<div class="modal-content">
							<form action="ClassServlet.do" method="post" name="ClassUpdateFrom">
								<div class="modal-header">
									<h4 class="modal-title" id="myModalLabel">修改班級資料資料</h4>
								</div>
								<div class="modal-body">
									<div class="form-group">
										<label class="control-label">班級代號:</label> <input type="text"
											class="form-control" name="class_id" value="${classVO.class_id}" readonly>
										<label style="color:red">${errorMsgs.class_idMsg}</label>
									</div>
									<div class="form-group">
										<label class="control-label">班級名稱:</label> <input type="text"
											class="form-control" name="class_name" value="${classVO.class_name}">
										<label style="color:red">${errorMsgs.class_nameMsg}</label>
									</div>
									<div class="form-group">
										<label class="control-label">聯絡人:</label> <input type="text"
											class="form-control" name="class_contact" value="${classVO.class_contact}">
										<label style="color:red">${errorMsgs.class_contactMsg}</label>
									</div>
									<div class="form-group">
										<label class="control-label">導師:</label> <input type="text"
											class="form-control" name="class_teach" value="${classVO.class_teach}">
										<label style="color:red">${errorMsgs.class_teachMsg}</label>
									</div>
									<div class="form-group">
										<label class="control-label">教育代號:</label> <input type="text"
											class="form-control" name="edu_id" value="${classVO.eduVO.edu_id}">
