...
<%--             <li><a href="#">使用者編號:${sessionScope.stuID}</a></li> --%>
		  ...
		  <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="${pageContext.request.contextPath}/01_login/LoginBegin.jsp"><span class="glyphicon glyphicon-log-in"></span>登入</a></li>
			</c:if>
			...
			<!-- 登出 -->
			<c:if test="${not empty LoginOK}">
            <li><a href="${pageContext.request.contextPath}/01_login/Logout.jsp"><span class="glyphicon glyphicon-log-out"></span>登出</a></li>
			</c:if>
