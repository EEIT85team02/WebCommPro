...
<link rel='stylesheet' href='${pageContext.request.contextPath}/fullcalendar/fullcalendar.print.css' />
<script src='${pageContext.request.contextPath}/fullcalendar/lib/moment.js'></script>
<link rel='stylesheet' href='${pageContext.request.contextPath}/bootstrap_year_calendar/css/bootstrap-year-calendar.css' />
...
<script src='${pageContext.request.contextPath}/bootstrap_year_calendar/js/bootstrap-year-calendar.js'></script>
<!-- 載入fullcalendar的語言包 -->
